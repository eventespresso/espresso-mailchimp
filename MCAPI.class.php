...
class MCAPI
{
    ...
    */
    ...
    public function __construct($api_key)
    {
        ...
        $this->verify_ssl = apply_filters('events_mailchimp__construct__verify_ssl', $this->verify_ssl);
    ...
    private function makeRequest($http_verb, $method, $args = array(), $timeout = 10)
    {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'Event Espresso Integration/MailChimp-API/v2 (https://eventespresso.com/forum/mailchimp-integration/)');
